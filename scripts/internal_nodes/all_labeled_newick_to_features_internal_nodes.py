...
# labeled_newick_path = "test_all_tissue_labels.nwk"
# tissues = str("PRL,HMR,LGR").split(",")
# output_name = "test_features_all_tree.csv"
...
labeled_tree.get_tree_root().name = f'0_{tissue_order[0]}'
